...
namespace BarkAndBarker.Persistence
{
    ...
    public class ModelCharacter
    {
        ...
        public static string QuerySelectAllByUserAccount = "SELECT * FROM barker.characters WHERE barker.characters.accountID = @AID AND barker.characters.IsDeleted IS NULL;";
        public static string QuerySelectCharacterByID = "SELECT * FROM barker.characters WHERE barker.characters.CharID = @CID AND barker.characters.IsDeleted IS NULL;";
        ...
        public static string QueryOwnerAccountForCharacterID = "SELECT barker.accounts.* FROM barker.accounts, barker.characters WHERE barker.characters.CharID = @CID"; // do not check if IsDeleted is NULL, this is used for account <-> char ownership checks.
        public static string QueryDeleteCharacter = "UPDATE barker.characters SET barker.characters.IsDeleted = CURRENT_TIMESTAMP WHERE (`accountID` = @AID) and (`CharID` = @CID);";
